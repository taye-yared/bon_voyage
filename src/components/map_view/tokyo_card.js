                ...
                <Card>
                    ...
                    <Card.Content extra style={{overflowY:'scroll', maxHeight:'42.5vh'}}>
                        ...
                        <Card.Content extra>
                            <a>
                                <Icon name='plane' />
                                AA ORD(7:05AM)->TYO(11:14AM)  $1145 
                            </a>
                        </Card.Content>
                        <Divider />
                        <Card.Content extra>
                        ...
                        <Card.Content extra>
                            <a>
                                <Icon name='plane' />
                                UA ORD(7:37AM)->TYO(11:42AM)  $1145
                            </a>
                        </Card.Content>
                        <Divider />
                        <Card.Content extra>
                            <a>
                                <Icon name='plane' />
                                UA ORD(8:37AM)->TYO(12:42PM)  $1155
                            </a>
                        </Card.Content>
                    </Card.Content>
